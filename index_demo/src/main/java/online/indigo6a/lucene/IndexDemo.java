...
public class IndexDemo {
    public static void main(String[] args) throws IOException {
        ...
        String textPath = "testdata/demo2";
    ...
    static void indexFile(IndexWriter writer, Path file,long lastModified) throws IOException {
        System.out.println("start index:"+file.getFileName());
